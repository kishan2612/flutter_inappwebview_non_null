...
class ServerTrustChallenge extends URLAuthenticationChallenge {
  ServerTrustChallenge({ URLProtectionSpace protectionSpace})
      : super(protectionSpace: protectionSpace);
...
class Favicon {
  ...
  Favicon({ this.url, this.rel, this.width, this.height});
...
class IOSWKFrameInfo {
  ...
  IOSWKFrameInfo(
      { this.isMainFrame,  this.request, this.securityOrigin});
...
class RenderProcessGoneDetail {
  ...
  RenderProcessGoneDetail(
      { this.didCrash, this.rendererPriorityAtExit});
