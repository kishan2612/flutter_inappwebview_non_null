      ...
      case "onSafeBrowsingHit":
        if ((_webview != null && _webview.androidOnSafeBrowsingHit != null) ||
          ...
          if (_webview != null && _webview.androidOnSafeBrowsingHit != null)
            ...
            return (await _inAppBrowser.androidOnSafeBrowsingHit(
                    uri, threatType))
                ?.toMap();
        }
        break;
...
"""))?.cast<Map<dynamic, dynamic>>() ?? [];
  ...
  Future<void> loadUrl(
      {URLRequest urlRequest, Uri? iosAllowingReadAccessTo}) async {
  ...
  ///```
  Future<void> postUrl({Uri url, Uint8List postData}) async {
  ...
  ///...
  ///```
  Future<void> loadFile({String assetFilePath}) async {
  ...
  Future<dynamic> evaluateJavascript(
      {String source, ContentWorld? contentWorld}) async {
    Map<String, dynamic> args = <String, dynamic>{};
  ...
  Future<void> injectJavascriptFileFromUrl(
      {Uri urlFile, ScriptHtmlTagAttributes? scriptHtmlTagAttributes}) async {
  ...
  ///Instead, you should call this method, for example, inside the [WebView.onLoadStop] event or in any other events
  ///where you know the page is ready "enough".
  Future<dynamic> injectJavascriptFileFromAsset({String assetFilePath}) async {
  ...
  Future<void> injectCSSFileFromUrl(
      {Uri urlFile, CSSLinkHtmlTagAttributes? cssLinkHtmlTagAttributes}) async {
    assert(urlFile.toString().isNotEmpty);
    Map<String, dynamic> args = <String, dynamic>{};
    args.putIfAbsent('urlFile', () => urlFile.toString());
    args.putIfAbsent(
  ...
  Future<void> setOptions({InAppWebViewGroupOptions options}) async {
    Map<String, dynamic> args = <String, dynamic>{};
  ...
  Future<void> scrollTo({int x, int y, bool animated = false}) async {
    Map<String, dynamic> args = <String, dynamic>{};
  ...
  ///
  ///**Official iOS API**: https://developer.apple.com/documentation/uikit/uiscrollview/1619400-setcontentoffset
  Future<void> scrollBy({int x, int y, bool animated = false}) async {
    Map<String, dynamic> args = <String, dynamic>{};
    args.putIfAbsent('x', () => x);
    args.putIfAbsent('y', () => y);
    args.putIfAbsent('animated', () => animated);
  ...
  Future<void> zoomBy({double zoomFactor, bool iosAnimated = false}) async {
...
(function() {
  ...
  Future<String?> saveWebArchive(
      {String filePath, bool autoname = false}) async {
    if (!autoname) {
      if (defaultTargetPlatform == TargetPlatform.android) {
  ...
  Future<void> postWebMessage({WebMessage message, Uri targetOrigin}) async {
  ...
  ///         <td><code trans="no" dir="ltr">SCHEME</code> is http or https; <code trans="no" dir="ltr">HOSTNAME_<wbr>PATTERN</code> is a regular hostname; <code trans="no" dir="ltr">PORT</code> is optional, when not present, the rule will match port <code trans="no" dir="ltr">80</code> for http and port
  ///            <code trans="no" dir="ltr">443</code> for https.
  ///         </td>
  ///         <td>
  ///            <ul>
  ///               <li><code trans="no" dir="ltr">https://foobar.com:8080</code> - Matches https:// URL on port 8080, whose normalized
  ///                  host is foobar.com.
  ///               </li>
  ///               <li><code trans="no" dir="ltr">https://www.example.com</code> - Matches https:// URL on port 443, whose normalized host
  ///                  is www.example.com.
  ///               </li>
  ///            </ul>
  ///         </td>
  ...
  ///         <td><code trans="no" dir="ltr">SCHEME</code> is http or https; <code trans="no" dir="ltr">HOSTNAME_<wbr>PATTERN</code> is a sub-domain matching
  ///            pattern with a leading <code trans="no" dir="ltr">*.<wbr></code>; <code trans="no" dir="ltr">PORT</code> is optional, when not present, the rule will
  ///            match port <code trans="no" dir="ltr">80</code> for http and port <code trans="no" dir="ltr">443</code> for https.
  ///         </td>
  ///         <td>
  ///            <ul>
  ///               <li><code trans="no" dir="ltr">https://*.example.com</code> - Matches https://calendar.example.com and
  ///                  https://foo.bar.example.com but not https://example.com.
  ///               </li>
  ///               <li><code trans="no" dir="ltr">https://*.example.com:8080</code> - Matches https://calendar.example.com:8080</li>
  ///            </ul>
  ///         </td>
  ///      </tr>
  ///      <tr>
  ///         <td>http/https with IP literal</td>
  ///         <td><code trans="no" dir="ltr">SCHEME</code> is https or https; <code trans="no" dir="ltr">HOSTNAME_<wbr>PATTERN</code> is IP literal; <code trans="no" dir="ltr">PORT</code> is
  ///            optional, when not present, the rule will match port <code trans="no" dir="ltr">80</code> for http and port <code trans="no" dir="ltr">443</code>
  ///            for https.
  ///         </td>
  ///         <td>
  ///            <ul>
  ///               <li><code trans="no" dir="ltr">https://127.0.0.1</code> - Matches https:// URL on port 443, whose IPv4 address is
  ///                  127.0.0.1
  ///               </li>
  ///               <li><code trans="no" dir="ltr">https://[::1]</code> or <code trans="no" dir="ltr">https://[0:0::1]</code>- Matches any URL to the IPv6 loopback
  ///                  address with port 443.
  ///               </li>
  ///               <li><code trans="no" dir="ltr">https://[::1]:99</code> - Matches any https:// URL to the IPv6 loopback on port 99.</li>
  ///            </ul>
  ///         </td>
  ///      </tr>
  ///      <tr>
  ///         <td>Custom scheme</td>
  ///         <td><code trans="no" dir="ltr">SCHEME</code> is a custom scheme; <code trans="no" dir="ltr">HOSTNAME_<wbr>PATTERN</code> and <code trans="no" dir="ltr">PORT</code> must not be
  ///            present.
  ///         </td>
  ///         <td>
  ///            <ul>
  ///               <li><code trans="no" dir="ltr">my-app-scheme://</code> - Matches any my-app-scheme:// URL.</li>
  ///            </ul>
  ///         </td>
  ///      </tr>
  ///      <tr>
  ///         <td><code trans="no" dir="ltr">*</code></td>
  ///         <td>Wildcard rule, matches any origin.</td>
  ///         <td>
  ///            <ul>
  ///               <li><code trans="no" dir="ltr">*</code></li>
  ///            </ul>
  ///         </td>
  ///      </tr>
  ///   </tbody>
