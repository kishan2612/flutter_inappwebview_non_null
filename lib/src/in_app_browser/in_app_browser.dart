...
class InAppBrowser {
  ...
  static Future<void> openWithSystemBrowser({ Uri url}) async {
  ...
  ///Note that for applications targeting Android N and r SDKs (API level > `Build.VERSION_CODES.M`) this method is only called for requests originating from secure origins such as https.
  ...
  ///Any red UI should therefore be hidden.
  ///
  ///**NOTE**: available only on Android.
  ///
