...
class X509Extension {
  ...
  String generalName({ ASN1Object item}) {
...
class BasicConstraintExtension extends X509Extension {
  BasicConstraintExtension({ block}) : super(block: block);
...
class SubjectKeyIdentifierExtension extends X509Extension {
  SubjectKeyIdentifierExtension({ block}) : super(block: block);
...
class AuthorityInfoAccess {
  ...
  AuthorityInfoAccess({ this.method,  this.location});
...
class AuthorityInfoAccessExtension extends X509Extension {
  AuthorityInfoAccessExtension({ block}) : super(block: block);
...
class AuthorityKeyIdentifierExtension extends X509Extension {
  AuthorityKeyIdentifierExtension({ block}) : super(block: block);
...
class CertificatePolicyQualifier {
  ...
  CertificatePolicyQualifier({ this.oid, this.value});
...
class CertificatePolicy {
  ...
  CertificatePolicy({ this.oid, this.qualifiers});
...
class CertificatePoliciesExtension extends X509Extension {
  CertificatePoliciesExtension({ block}) : super(block: block);
...
class CRLDistributionPointsExtension extends X509Extension {
  CRLDistributionPointsExtension({ block}) : super(block: block);
