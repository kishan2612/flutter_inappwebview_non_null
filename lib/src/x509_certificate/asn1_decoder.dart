...
class ASN1DERDecoder {
  static List<ASN1Object> decode({ List<int> data}) {
    var iterator = data.iterator;
    return parse(iterator: iterator);
  }

  static List<ASN1Object> parse({ Iterator<int> iterator}) {
  ...
  static BigInt getContentLength({ Iterator<int> iterator}) {
  ...
  static List<int> loadSubContent({ Iterator<int> iterator}) {
  ...
  static String decodeOid({ List<int> contentData}) {
    if (contentData.isEmpty) {
      return null;
    }
  ...
  static DateTime utcTimeToDate({ List<int> contentData}) {
  ...
  static DateTime generalizedTimeToDate({ List<int> contentData}) {
    /* The following formats can be used:
      YYYYMMDDHHMMSS
      YYYYMMDDHHMMSS.fff
      YYYYMMDDHHMMSSZ
  ...
  static List<int> sequenceContent({ List<int> data}) {
    var iterator = data.iterator;
    iterator.moveNext();
    try {
