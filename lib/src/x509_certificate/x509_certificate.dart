...
class X509Certificate {
  ...
  static X509Certificate fromData({ Uint8List data}) {
  ...
  static X509Certificate fromDerData({ Uint8List der}) {
  ...
  static X509Certificate fromPemData({ Uint8List pem}) {
  ...
  static Uint8List decodeToDER({ pemData}) {
...
dynamic firstLeafValue({ ASN1Object block}) {
  var sub = block.sub;
  if (sub != null && sub.length > 0) {
    ASN1Object subFirst;
    try {
